...
for csv_file in csv_files:
    ...
    x_cols = [0] + list(range(2, 7))  # [0, 2, 3, 4, 5, 6]
...
X_bif = np.stack(X_list)  # shape: (num_samples, 400, 6)
print(X_bif.shape)
# Example random data
X = np.random.rand(427,400,6)
...
model_cnn = Sequential([
    Conv1D(64, kernel_size=5, activation='relu', padding='same', input_shape=(400, 6)),
    BatchNormalization(),
    Dropout(0.3),
