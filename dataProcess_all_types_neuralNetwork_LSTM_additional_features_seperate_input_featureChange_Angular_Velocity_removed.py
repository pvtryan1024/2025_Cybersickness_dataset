...
for csv_file in csv_files:
    ...
    x_final = np.delete(x_final, [4,5,6], axis=1)  # shape: (420, 9)  
    print("Final x shape:", x_final.shape)
...
# Inputs
ts_input = Input(shape=(420, 4), name='time_series_input')    # dynamic input
...
#     plt.ylim(0, 20)
#     plt.title("LSTM Angular Velocity Removed (Sample " + str(i) + ")")
#     plt.legend()
#     plt.show()
